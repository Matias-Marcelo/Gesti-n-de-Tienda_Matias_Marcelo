...
public class ShopView extends JFrame implements ActionListener, KeyListener{
	...
	public ShopView() {
		...
		JButton btnNewButton_1 = new JButton("2. A帽adir producto");
		...
		JButton btnNewButton_2 = new JButton("3. A帽adir stock");
		...
		txtpnRewr.setText("Seleccione o pulse una opci贸n:");
		 ...
		 //Save in string variable the commands with their previously edited names
	       ...
	       //Switch to call the corresponding method according to the command in the string
	            case "Cash":
	                ...
	                break;
	            case "AddProduct":
	                setTitle("A帽adir Producto");
	                openProductView(2,shop);
	                break;
	            case "AddStock":
	            	setTitle("A帽adir Stock");
	            ...
	            case "ExportInventory":
	                ...
	                if (shop.writeInventory()) {
	                    // Si la exportaci髇 fue exitosa, muestra una ventana con mensaje de 閤ito
	                    JOptionPane.showMessageDialog(this, "Inventario exportado correctamente.", "Informaci髇", JOptionPane.INFORMATION_MESSAGE);
	                } else {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch (key) {
            case KeyEvent.VK_1: // Opci贸n 1: Contar caja
                openCashView();
                break;
            case KeyEvent.VK_2: // Opci贸n 2: A帽adir producto
                openProductView(2,shop);
                break;
            case KeyEvent.VK_3: // Opci贸n 3: A帽adir stock
                openProductView(3,shop);
                break;
            case KeyEvent.VK_9: // Opci贸n 9: Eliminar producto
                openProductView(9,shop);
                break;
            default:
                break;
